...
//            com.tv.Television.MIN_VOLUME + " and " + com.tv.Television.MAX_VOLUME);
...
//        String volumeString = isMuted() ? "<is"
        return String.format("com.tv.Television: brand = %s, volume = %s, display=%s\n", getSetBrand(), getVolume(), getDisplay());
//        return "com.tv.Television: brand = " + getSetBrand() + ", volume= " + getVolume() + ", display= " + display;
    }
