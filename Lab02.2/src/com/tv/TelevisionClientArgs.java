 ...
 *  $ java com.tv.TelevisionClientArgs <brand> <volume> <display>
 * 
 * Example:
 *  $ java com.tv.TelevisionClientArgs Samsung 32 PLASMA
 *
 * GOAL:
 *  Create an instance of com.tv.Television with the specifications (values) provided by the user.
 */
class TelevisionClientArgs {
    ...
    public static void main(String[] args) {
        ...
        if (args.length < 3) {
            String usage = "Usage: java com.tv.TelevisionClientArgs <brand> <volume> <display>";
        ...
        //now create an instance of com.tv.Television of these converted inputs
